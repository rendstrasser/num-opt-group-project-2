...
def create_example_18_3_problem():
    """
    Example 18.3 from the book (non-convex!)
    """
...
def create_convex_in_f_problem() -> MinimizationProblem:
    """
    Custom example for a problem that is non-linear in the constraints and convex in the objective.
    """
...
def create_made_up_problem_2():
    """
    Custom, non-convex problem.

    Takes a little bit longer to compute, but is solved by the algorithm!
    This example shows that we have local convergence even for non-convex problems.
    """
...
def create_made_up_problem_3():
    """
    Custom, non-convex problem that converges.
    """
